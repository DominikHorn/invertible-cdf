...
class CompactHistTree {
 public:
  ...
  CompactHistTree(bool single_layer, KeyType min_key, KeyType max_key,
                  size_t num_keys, size_t num_bins, size_t log_num_bins,
                  size_t max_error, size_t shift, std::vector<unsigned> table)
